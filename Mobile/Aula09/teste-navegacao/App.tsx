...
const TelaBFormulario = () => { 
  return (
    <View style={{flex: 1, backgroundColor: "lightyellow"}}>
      <Text style={{fontSize: 32, color: "blue"}}>Tela B Formulario</Text>
    </View>
  )
}
...
const TelaBLista = () => { 
  return (
    <View style={{flex: 1, backgroundColor: "lightcyan"}}>
      <Text style={{fontSize: 32, color: "blue"}}>Tela B Lista</Text>
    </View>
  )
}
...
const TelaB = () => { 
  return (
    <View style={{flex: 1}}>
      <TabNavigator>
        <TabScreen name="Formulario" component={TelaBFormulario}/>
        <TabScreen name="Lista" component={TelaBLista}/>
      </TabNavigator>
    </View>
  )
}
